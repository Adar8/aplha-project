...
export const LEVELS = [
  { id: 'basic', label: 'בסיסי', hint: 'הסבר פשוט, עם דוגמאות מהיום-יום' },
...
export const QUESTIONS = [
  {
    ...
    options: [
      ...
      { id: 'experienced', label: 'יש לי ניסיון קבוע בהשקעות או במסחר', hint: 'הבסיס מוכר לי, ואני רוצה לסגור פערים' },
    ],
  },
  {
    id: 'goal',
  ...
  },
  {
    ...
    optional: true,
    title: 'טווח גילאים',
    note: 'לא חובה. עוזר לבחור דוגמאות רלוונטיות, וקובע את סגנון התצוגה בהתחלה (אפשר להחליף אותו בתפריט).',
    options: [
      { id: 'u25', label: 'עד 25' },
