  ...
  return (
    ...
    >
      ...
      <section aria-labelledby="rr">
        ...
        <Deep>
          <p>אחוז ההצלחה שבו יוצאים באפס הוא 1 ÷ (1 + R). ב-<bdi className="mono">2R</bdi> זה <bdi className="mono">33.3%</bdi>, וב-<bdi className="mono">3R</bdi> זה <bdi className="mono">25%</bdi>. אבל יעד רחוק יותר מושג בדרך כלל לעיתים רחוקות יותר, אז יחס גבוה לא מגיע ״בחינם״.</p>
