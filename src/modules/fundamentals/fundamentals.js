...
export const COMPANIES = [
  ...
  },
  {
    ...
    dividend: 0,
    history: [20, 38, 60],
    story: 'חברת תוכנה צעירה. הרווח שלה כמעט הוכפל בכל שנה. אין לה חובות והיא לא מחלקת דיבידנד: כל שקל מושקע בצמיחה.',
  },
  {
    id: 'steel',
    name: 'פלדת הצפון',
    ...
    dividend: 0.5,
    history: [300, 220, 400],
    story: 'מפעל ותיק. השנה מכר קרקע ברווח חד-פעמי של ₪250 מיליון. בלי המכירה הרווח ממשיך לרדת, וגם החוב גבוה.',
  },
  {
    id: 'solar',
    name: 'אנרגיה ירוקה',
...
export const QUESTIONS = [
  ...
  },
  {
    ...
    answer: 'a',
    explain:
      'כשאין רווח, בודקים מכפילים אחרים, כמו מכפיל מכירות, ואת המגמה: ההפסד מצטמצם מ-₪60 מיליון ל-₪20 מיליון. זו עדיין השקעה ספקולטיבית יותר.',
  },
]
