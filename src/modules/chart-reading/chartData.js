...
/** מחולל אקראי דטרמיניסטי (mulberry32): אותו seed → אותה סדרה */
...
export const SCENARIOS = [
  ...
  },
  {
    ...
    reveal:
      '200 הייתה תמיכה שהחזיקה שלוש פעמים. אחרי שנשברה, היא עצרה את המחיר מלמעלה ונהייתה התנגדות. מי שקנה סביב 200 ו״נתקע״ בהפסד שמח למכור כשהמחיר חזר לשם, ולכן הרמה עוצרת את העלייה.',
  },
]
