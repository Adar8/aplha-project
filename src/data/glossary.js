...
const BASE_TERMS = [
  ...
  },
  {
    ...
    category: 'funds',
    definition:
      'קרן פרטית למשקיעים עשירים או מוסדיים, שמשתמשת באסטרטגיות מורכבות כמו מינוף ומכירה בחסר. היא פתוחה רק למשקיעים ״כשירים״, ולכן כפופה לפחות רגולציה מקרן נאמנות.',
  ...
  },
  {
    ...
    category: 'securities',
    definition:
      'הלוואה לחברה. מכיוון שחברה יכולה להיקלע לקשיים, הריבית גבוהה יותר מאשר באג״ח ממשלתית. ככל שהדירוג נמוך יותר, הריבית (והסיכון) גבוהים יותר.',
  ...
  },
  {
    ...
    definition:
      'מדד שמודד את השינוי במחיר של סל קבוע של מוצרים ושירותים שמשפחה ממוצעת קונה. בישראל הלמ״ס מפרסמת אותו מדי חודש, ולפיו מחושבות ההצמדות למדד.',
  ...
  },
  {
    ...
    definition:
      'הכלים של הבנק המרכזי לשלוט בכמות הכסף ובמחירו: בעיקר הריבית, ולפעמים גם קניית אג״ח בהיקפים גדולים (״הרחבה כמותית״).',
  ...
  },
  {
    ...
    category: 'mortgages',
    definition:
      'שיטת החזר שבה מחזירים כל חודש את אותו חלק מהקרן, ולכן ההחזר הראשון גבוה והוא יורד עם הזמן. בסך הכול משלמים פחות ריבית מאשר בשפיצר.',
    related: ['spitzer'],
  },
  {
    id: 'ltv',
  ...
  },
  {
    ...
    definition:
      'מערכות הדיווח של שוק ההון בישראל: במגנ״א (של רשות ניירות ערך) ובמאי״ה (של הבורסה) חברות ציבוריות מפרסמות דוחות כספיים ודיווחים מיידיים. הגישה אליהן חינמית ופתוחה לכולם.',
    related: ['isa', 'tase'],
  },
  {
    id: 'sec',
